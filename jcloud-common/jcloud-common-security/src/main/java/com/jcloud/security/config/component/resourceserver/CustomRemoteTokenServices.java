...
public class CustomRemoteTokenServices implements ResourceServerTokenServices {
    ...
    private AccessTokenConverter tokenConverter = null;
    ...
    public OAuth2Authentication loadAuthentication(String accessToken) throws AuthenticationException, InvalidTokenException {
        ...
        try {
            ...
            throw new InvalidTokenException("远程服务调用异常,请重试" + e.getMessage());
        }
        if (map.containsKey("code")) {
            if (logger.isDebugEnabled()) {
                logger.debug("check_token returned error: " + map.get("error"));
            }
            throw new InvalidTokenException(map.get("msg").toString());
        }
