...
import com.alibaba.csp.sentinel.dashboard.controller.SystemController;
import com.alibaba.csp.sentinel.dashboard.datasource.entity.rule.SystemRuleEntity;
import com.alibaba.csp.sentinel.dashboard.domain.Result;
import com.alibaba.csp.sentinel.dashboard.repository.rule.RuleRepository;
import com.alibaba.csp.sentinel.dashboard.rule.system.SystemRuleNacosProvider;
...
public class SystemRuleControllerV2 {
    ...
    @Autowired
    private SystemRuleNacosProvider ruleProvider;

    @Autowired
    private SystemRuleNacosPublisher rulePublisher;
