...
import com.alibaba.csp.sentinel.dashboard.rule.gateway.GatewayFlowRuleProvider;
import com.alibaba.csp.sentinel.dashboard.rule.gateway.GatewayFlowRulePublisher;
...
public class GatewayFlowRuleController {
    ...
    @Autowired
    private GatewayFlowRuleProvider ruleProvider;

    @Autowired
    private GatewayFlowRulePublisher rulePublisher;
