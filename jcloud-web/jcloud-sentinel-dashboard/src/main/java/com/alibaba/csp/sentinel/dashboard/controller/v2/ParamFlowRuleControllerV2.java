...
import com.alibaba.csp.sentinel.dashboard.rule.param.ParamRuleProvider;
import com.alibaba.csp.sentinel.dashboard.rule.param.ParamRulePublisher;
...
public class ParamFlowRuleControllerV2 {
    ...
    @Autowired
    private ParamRuleProvider ruleProvider;

    @Autowired
    private ParamRulePublisher rulePublisher;
    ...
    public Result<List<ParamFlowRuleEntity>> apiQueryAllRulesForMachine(@RequestParam String app,
        ...
        try {
            ...
            logger.error("Error when querying parameter flow rules", throwable.getCause());
