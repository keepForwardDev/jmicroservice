...
import com.alibaba.csp.sentinel.dashboard.rule.gateway.GatewayApiProvider;
import com.alibaba.csp.sentinel.dashboard.rule.gateway.GatewayApiPublisher;
...
public class GatewayApiController {
    ...
    @Autowired
    private GatewayApiPublisher apiPublisher;

    @Autowired
    private GatewayApiProvider gatewayApiProvider;
