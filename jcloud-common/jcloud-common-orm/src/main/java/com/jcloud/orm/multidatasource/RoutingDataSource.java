...
public class RoutingDataSource extends AbstractAutoProxyCreator
        ...
        if (defaultTargetDataSource != null) {
            ...
            if (defaultTargetDataSource instanceof String) {
                ...
                try {
                    ...
                    this.resolvedDefaultTargetDataSource = getBeanFactory().getBean(DataSource.class);
                }
                return;
            }
    ...
    protected DataSource determineTargetDataSource() {
        ...
        if (dataSource == null && StringUtils.isNotBlank(lookupKey)) {
            throw new NotFoundException("the dataSource is not found : " + lookupKey);
        } else {
